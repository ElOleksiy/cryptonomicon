  ...
  <div class="container mx-auto flex flex-col items-center bg-gray-100 p-4">
    ...
    <div class="container">
      <section>
        ...
        <button type="button" @click="addCard()" class=" my-4 inline-flex items-center py-2 px-4 border border-transparent shadow-sm text-sm leading-4
      ...
      <div v-show="paginationTickers.length !== 0">
        <hr class="w-full border-t border-gray-600 my-4" />
        <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
          <div @click="selectTicker(card)" v-for="(card, idx) in paginationTickers" :key="idx"
            ...
            <button @click.stop="selectTicker()" @click="deleteCard(card)"
